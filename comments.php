...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Doubt cleared successfully!';
   }else{
      $message[] = 'Doubt already cleared!';
   }
...
if(isset($_POST['update_now'])){
   ...
   if($verify_comment->rowCount() > 0){
      $message[] = 'Doubt already added!';
   }else{
      $update_comment = $conn->prepare("UPDATE `comments` SET comment = ? WHERE id = ?");
      $update_comment->execute([$update_box, $update_id]);
      $message[] = 'Doubt edited successfully!';
   }
...
<section class="edit-comment">
   <h1 class="heading">Edit query</h1>
...
<section class="comments">
   ...
   <h1 class="heading">Your queries</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('delete this comment?');">Delete doubt</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty">No queries added yet!</p>';
      }
      ?>
      </div>
