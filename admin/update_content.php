...
if(isset($_POST['update'])){
   ...
   if (!empty($docs)) {
      ...
      // Update the database with the new document filename
      $update_content->execute([$title, $description, $status, $rename_docs, $video_id]); // Add $rename_docs to the query

      // Delete the old document if necessary
      if ($old_docs != '' AND $old_docs != $rename_docs) {
          unlink('../uploaded_files/' . $old_docs);
      }
  }
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Update timings <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Timings" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>update playlist</p>
