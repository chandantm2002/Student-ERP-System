...
<section class="view-content">
   ...
   <div class="container">
      ...
      <div class="flex">
         <div><i class="fa-solid fa-clipboard-user"></i><span><?= $total_likes; ?></span></div>
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $docs_id; ?>" class="option-btn">update</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Delete this document?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
