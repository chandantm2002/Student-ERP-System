...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Class timings and platform <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Timings" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      <p>Class thumbnail <span>*</span></p>
      <div class="thumb">
      ...
      <div class="flex-btn">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">View Class</a>
      </div>
   </form>
   <?php
      } 
