...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <div class="info">
         ...
         <p><i class="fa-solid fa-clipboard-user"></i><span><?= $total_likes; ?> Attendance</span></p>
      </div>
      <div class="tutor">
      ...
      <form action="" method="post" class="flex">
         ...
         ?>
         <button type="submit" name="like_content"><i class="fa-solid fa-clipboard-user"></i><span>Attended</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="fa-solid fa-clipboard-user"></i><span>Present</span></button>
         <?php
            }
         ?>
      </form>
...
<section class="comments">
   ...
   <h1 class="heading">Add a query</h1>
   ...
   <h1 class="heading">User doubts</h1>
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty">No doubts asked yet!</p>';
      }
      ?>
      </div>
