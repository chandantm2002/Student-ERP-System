   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Save class</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <div class="col">
         ...
         <div class="details">
            ...
            <p href="https://meet.google.com/wth-guua-gnz" onclick="openMeet()"style="cursor: pointer;"p><?= $fetch_playlist['description']; ?></a>
...
function openMeet() {
  window.open("https://meet.google.com/", "_blank");
      ...
      <?php
            ...
            echo '<p class="empty">This class was not found!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading">Class videos</h1>
